...
for y, cls in enumerate(classes):
    ...
    for i, idx in enumerate(idxs):
        ...
        if i == 0:
            plt.title(cls)
# plt.show()
fig.savefig('samples_knn.png', transparent=True)
...
# plt.show()
fig.savefig('distance_matrix.png', transparent=True)
...
# k = 5 arbitrarily. We will now determine the best value of this hyperparameter
...
# plt.show()
fig.savefig('cros-validation-accuracy.png', transparent=True)
