...
# plt.show()
fig.savefig('training_loss_history', transparent=True)
...
# plt.show()
fig.savefig('loss_classacc.png', transparent=True)
...
hidden_size = [40, 60, 80, 100, 120, 200, 400]
learning_rate = [1e-6, 1e-5, 1e-4, 5e-4, 1e-3, 5e-3, 1e-2]
reg = [0.1, 0.2, 0.4, 0.6, 0.8]
# hidden_size = [60]
# learning_rate = [1e-3]
# reg = [0.2]
best_acc = -1
